                    ...
                    <div className="col-6">
                        ...
                        <h2 style={{textAlign: "center"}}>Register form</h2>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    <label for="number" className="col-form-label">Referal:</label>
                                    <input type="number" className="form-control" onChange={inputHandle} name="referal" minLength={5} required />
                                </div>
                                <div className="mb-3">
                                    <label for="city" className="col-form-label">City.:</label>
                                    <input type="text" className="form-control" onChange={inputHandle} name="city" />
                                </div>
